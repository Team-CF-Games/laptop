...
laptop.register_app("tetris", {
	...
	app_info = "Tetris - Chutes de tuile",

	formspec_func = function(app, mtos)
		local data = mtos.bdev:get_app_storage('ram', 'tetris')
		local tetris = get_tetris(app, data)
		if not data.t then
			return mtos.theme:get_button('2,4;2,2', 'major', 'new', 'Nouv. Partie', 'Commencer une nouvelle partie')
		end
		...
		local buttons = mtos.theme:get_button('6,6;1,1', 'minor', 'left', '<')..
						...
						mtos.theme:get_button('6,3.5;3,1', 'major', 'new', 'Nouv. Partie', 'Commencer une nouvelle partie')
		...
		return 'container[3,1]background[0,-0.05;4.35,9;'.. mtos.theme.contrast_background .. ']' ..
			...
			mtos.theme:get_label('6.5,0.1', 'Suivant...') ..
